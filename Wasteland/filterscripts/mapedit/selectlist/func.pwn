...
GetSelectListCaption(playerid, caption[], caption_size) {
    switch( g_PlayerData[playerid][PLAYER_DATA_TDMODE] ) {
        case TDMODE_SELECTLIST_OBJECT: {
            format(caption, caption_size, "Выбор объекта");
        }
        case TDMODE_SELECTLIST_VEHICLE: {
            format(caption, caption_size, "Выбор автомобиля");
        }
        case TDMODE_SELECTLIST_ACTOR: {
            format(caption, caption_size, "Выбор актера");
        }
        case TDMODE_SELECTLIST_PICKUP: {
            format(caption, caption_size, "Выбор пикапа");
        }
        default: {
            return format(caption, caption_size, "Выбрать"), 0;
        }
    }
    return 1;
...
ApplySelectListColumns(playerid) {
    switch( g_PlayerData[playerid][PLAYER_DATA_TDMODE] ) {
        case TDMODE_SELECTLIST_OBJECT: {
            PlayerTextDrawSetString(playerid, g_SelectListPTD[playerid][SELECTLIST_PTD_ID_COL], "ID объекта");
            PlayerTextDrawSetString(playerid, g_SelectListPTD[playerid][SELECTLIST_PTD_MODELID_COL], "Название объекта");
            PlayerTextDrawSetString(playerid, g_SelectListPTD[playerid][SELECTLIST_PTD_COMMENT_COL], "Комментарий к объекту");
        }
        case TDMODE_SELECTLIST_VEHICLE: {
            PlayerTextDrawSetString(playerid, g_SelectListPTD[playerid][SELECTLIST_PTD_ID_COL], "ID автомобиля");
            PlayerTextDrawSetString(playerid, g_SelectListPTD[playerid][SELECTLIST_PTD_MODELID_COL], "Название автомобиля");
            PlayerTextDrawSetString(playerid, g_SelectListPTD[playerid][SELECTLIST_PTD_COMMENT_COL], "Комментарий к автомобилю");
        }
        case TDMODE_SELECTLIST_ACTOR: {
            PlayerTextDrawSetString(playerid, g_SelectListPTD[playerid][SELECTLIST_PTD_ID_COL], "ID актера");
            PlayerTextDrawSetString(playerid, g_SelectListPTD[playerid][SELECTLIST_PTD_MODELID_COL], "Название скина");
            PlayerTextDrawSetString(playerid, g_SelectListPTD[playerid][SELECTLIST_PTD_COMMENT_COL], "Комментарий к актеру");
        }
        case TDMODE_SELECTLIST_PICKUP: {
            PlayerTextDrawSetString(playerid, g_SelectListPTD[playerid][SELECTLIST_PTD_ID_COL], "ID пикапа");
            PlayerTextDrawSetString(playerid, g_SelectListPTD[playerid][SELECTLIST_PTD_MODELID_COL], "Модель пикапа");
            PlayerTextDrawSetString(playerid, g_SelectListPTD[playerid][SELECTLIST_PTD_COMMENT_COL], "Комментарий к пикапу");
        }
        default: {
            PlayerTextDrawSetString(playerid, g_SelectListPTD[playerid][SELECTLIST_PTD_ID_COL], "ID");
            PlayerTextDrawSetString(playerid, g_SelectListPTD[playerid][SELECTLIST_PTD_MODELID_COL], "Модель");
            PlayerTextDrawSetString(playerid, g_SelectListPTD[playerid][SELECTLIST_PTD_COMMENT_COL], "Комментарий");
            return 0;
        }
    }
    return 1;
...
ApplySelectListPage(playerid) {
    format(g_TextdrawString, sizeof g_TextdrawString, "Страница %i / %i", GetSelectListPage(playerid) + 1, GetSelectListMaxPage(playerid) + 1);
...
ApplySelectListSearch(playerid) {
    ...
    if( isempty(g_SearchString) ) {
        PlayerTextDrawSetString(playerid, g_SelectListPTD[playerid][SELECTLIST_PTD_SEARCH], "Поиск");
    } else {
        format(g_TextdrawString, sizeof g_TextdrawString, "Поиск: %s", g_SearchString);
...
ShowSelectListDialog(playerid, dialogid) {
    switch( dialogid ) {
        case DIALOGID_SELECTLIST_PAGE: {
            ...
            strcat(g_DialogCaption, ": Страница", sizeof g_DialogCaption);

            format(g_DialogInfo, sizeof g_DialogInfo, "Страница: %i / %i", GetSelectListPage(playerid) + 1, GetSelectListMaxPage(playerid) + 1);
        ...
        case DIALOGID_SELECTLIST_SEARCH: {
            GetSelectListCaption(playerid, g_DialogCaption, sizeof g_DialogCaption);
            strcat(g_DialogCaption, ": Поиск", sizeof g_DialogCaption);
