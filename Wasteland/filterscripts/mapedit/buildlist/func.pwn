...
ShowBuildListDialog(playerid, dialogid) {
    switch( dialogid ) {
        ...
        case DIALOGID_BUILDLIST_REMOVE: {
            ...
            g_DialogCaption = "Buildings: Удалить объект";
            ...
            ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_MSGBOX, g_DialogCaption, g_DialogInfo, "Удалить", "Отмена");
        }
        case DIALOGID_BUILDLIST_RECREATE: {
            ...
            g_DialogCaption = "Buildings: Востановить объект";
            format(g_DialogInfo, sizeof g_DialogInfo, "\
                Building ID:\t%i\n\
                Model ID:   \t%i\n\
                Model Name: \t%s",
            ...
            ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_MSGBOX, g_DialogCaption, g_DialogInfo, "Востановить", "Отмена");
	    }
        default: {
            return 0;
        }
