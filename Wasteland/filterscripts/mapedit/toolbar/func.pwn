CreateToolbarTextdraws() {
    ...
    TextDrawCreate          (258.0, 371.0, "I.F.E");
    ...
    TextDrawSetSelectable   (g_ToolbarTextdraw[TD_TOOLBAR_MISC_INFO], 0);
}
...
CreateToolbarKeyTextdraw(playerid, bool:mousemode) {
    ...
    if( mousemode ) {
        g_ToolbarKeyTextdraw[playerid] = CreatePlayerTextDraw(playerid, 637.0, 296.0, " ");
    } else {
        if( GetPlayerState(playerid) == PLAYER_STATE_SPECTATING ) {
            g_ToolbarKeyTextdraw[playerid] = CreatePlayerTextDraw(playerid, 637.0, 425.0, " ");
        } else {
            g_ToolbarKeyTextdraw[playerid] = CreatePlayerTextDraw(playerid, 637.0, 425.0, " ");
        }
    }
