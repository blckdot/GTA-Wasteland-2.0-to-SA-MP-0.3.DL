...
ShowCategoryManagerDialog(playerid, dialogid) {
    switch( dialogid ) {
        case DIALOGID_CATMANAGER_CAT_CREATE: {
            g_DialogCaption = "Меню: Создать категорию";
            g_DialogInfo = "Введите имя своей категории.";
            ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_INPUT, g_DialogCaption, g_DialogInfo, "Создать", "Отменить");
        }
        case DIALOGID_CATMANAGER_CAT_DESTROY: {
            ...
            g_DialogCaption = "Меню: Удалить категорию";
            format(g_DialogInfo, sizeof g_DialogInfo, "Введите '%s' для того чтобы удалить категорию.", CATMANAGER_DELETE_CODE);
            ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_INPUT, g_DialogCaption, g_DialogInfo, "Удалить", "Отменить");
        }
        case DIALOGID_CATMANAGER_CAT_RENAME: {
            ...
            g_DialogCaption = "Меню: Переименовать категорию";
            g_DialogInfo = "Введите новое имя для категории.";
            ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_INPUT, g_DialogCaption, g_DialogInfo, "Переименовать", "Отменить");
        }
        case DIALOGID_CATMANAGER_PAGE_ALL, DIALOGID_CATMANAGER_PAGE_CAT: {
            ...
            format(g_DialogInfo, sizeof g_DialogInfo, "Страница: %i / %i", GetCategoryManagerPage(playerid, window) + 1, GetCategoryManagerMaxPage(playerid, window) + 1);
            ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_INPUT, "Меню: Страница", g_DialogInfo, "Дальше", "Отмена");
        }
        case DIALOGID_CATMANAGER_SEARCH_ALL, DIALOGID_CATMANAGER_SEARCH_CAT: {
            ...
            ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_INPUT, "Меню: Поиск", g_DialogInfo, "Дальше", "Отмена");
        }
        default: {
            return 0;
        }
